function udscom_legacy()
    ...
    switch platform
        ...
        case 'windows'
            ...
            [availableInterfaces,fig.UserData.canHandle]  = detectAvailablePCANInterfaces_Windows();
        otherwise
    ...
    fig.UserData.canInterface = availableInterfaces;
    %fig.UserData.canHandle    = availableInterfaces{2};
    disp(availableInterfaces)
    disp(['Interfaces detected: ' strjoin(string(availableInterfaces), ', ')]);
    ...
    if strcmp(availableInterfaces, 'N/A')
        ...
        userMessage(fig, ['Interfaces detected: ' strjoin(string(availableInterfaces), ', ')]);
    end
end
...
function cleanupOnExit(figHandle)
    ...
    switch platform
        ...
        case 'windows'
            CANInterface_Windows('cleanup',figHandle.UserData.canHandle);
    end
...
function [availableInterfaces, canHandle] = detectAvailablePCANInterfaces_Windows()
    [availableInterfaces, canHandle] = CANInterface_Windows('detect');
end
